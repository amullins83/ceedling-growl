...
#define NUM_TPL_ENTRIES 							6												// was 2
#define USB_NUM_CONTROL_NAKS 						2000											// was 20
#define USB_SUPPORT_INTERRUPT_TRANSFERS
#define USB_NUM_INTERRUPT_NAKS 						20

#define USB_SUPPORT_BULK_TRANSFERS																	// new
#define USB_NUM_BULK_NAKS 							20000											// new
//#define USB_SUPPORT_ISOCHRONOUS_TRANSFERS															// new
