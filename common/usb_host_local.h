...
#define SUBSTATE_SET_FTDI_RESET                         0x0050  //
#define SUBSUBSTATE_SEND_RESET_PORT                     0x0000  //
#define SUBSUBSTATE_WAIT_FOR_RESET_PORT                 0x0001  //
#define SUBSUBSTATE_SET_RESET_COMPLETE                  0x0002  //

#define SUBSTATE_SET_FTDI_MODEM_CONTROL                 0x0060  //
#define SUBSUBSTATE_SEND_MODEM_CONTROL                  0x0000  //
#define SUBSUBSTATE_WAIT_FOR_MODEM_CONTROL              0x0001  //
#define SUBSUBSTATE_SET_MODEM_CONTROL_COMPLETE          0x0002  //

#define SUBSTATE_SET_FTDI_FLOW_CONTROL                  0x0070  //
#define SUBSUBSTATE_SEND_FLOW_CONTROL                   0x0000  //
#define SUBSUBSTATE_WAIT_FOR_FLOW_CONTROL               0x0001  //
#define SUBSUBSTATE_SET_FLOW_CONTROL_COMPLETE           0x0002  //

#define SUBSTATE_SET_FTDI_BAUDRATE                      0x0080  //
#define SUBSUBSTATE_SEND_BAUDRATE                       0x0000  //
#define SUBSUBSTATE_WAIT_FOR_BAUDRATE                   0x0001  //
#define SUBSUBSTATE_SET_BAUDRATE_COMPLETE               0x0002  //

#define SUBSTATE_SET_FTDI_DATA                          0x0090  //
#define SUBSUBSTATE_SEND_DATA                           0x0000  //
#define SUBSUBSTATE_WAIT_FOR_DATA                       0x0001  //
#define SUBSUBSTATE_SET_DATA_COMPLETE                   0x0002  //

#define SUBSTATE_SET_FTDI_SETBITMODE                    0x00A0  //
#define SUBSUBSTATE_SEND_SETBITMODE                     0x0000  //
#define SUBSUBSTATE_WAIT_FOR_SETBITMODE                 0x0001  //
#define SUBSUBSTATE_SETBITMODE_COMPLETE                 0x0002  //
