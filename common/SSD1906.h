...
#define PMDIN2	PMDIN	// testing.. insert new PMDIN2
...
#define BROWN               RGB565CONVERT(128,  64,    0)											// (Test v0.00.03)
...
#define BRICKRED			RGB565CONVERT(174, 	29, 	18)

#define BURNTYELLOW        	RGB565CONVERT(192,  192,    0)											// (9DP v1.01.04)

/****	Test RGB Color Shades	****/
#define RED0				RGB565CONVERT(8,	0,		0)
#define RED1				RGB565CONVERT(16,	0,		0)
#define RED2				RGB565CONVERT(32,	0,		0)
#define RED3				RGB565CONVERT(64,	0,		0)
#define RED4				RGB565CONVERT(128,  0,		0)

#define GREEN0				RGB565CONVERT(0,	4,		0)
#define GREEN1				RGB565CONVERT(0,	8,		0)
#define GREEN2				RGB565CONVERT(0,	16,		0)
#define GREEN3				RGB565CONVERT(0,	32,		0)
#define GREEN4				RGB565CONVERT(0,	64,		0)
#define GREEN5				RGB565CONVERT(0,	128,	0)

#define BLUE0				RGB565CONVERT(0,	0,		8)
#define BLUE1				RGB565CONVERT(0,	0,     	16)
#define BLUE2				RGB565CONVERT(0,	0,     	32)
#define BLUE3				RGB565CONVERT(0,	0,     	64)
#define BLUE4				RGB565CONVERT(0,	0,     	128)
...
// for 90 degrees and 270 degrees oriented
#define GetMaxX()	319		//319 for 90 deg  -- 239 for 0 deg -- disp ver resolution - 1
...
// for 90 degree and 270 degree oriented
#define GetMaxY()	239		//239 for 90 deg  -- 319 for 0 deg -- disp hor resolution - 1
