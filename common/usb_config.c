...
USB_TPL usbTPL[] =
{
	...
	,
	{ INIT_VID_PID( 0x04BFul, 0x0320ul ), 0, 0, {0} } 							// Bluetooth
    ,
    { INIT_VID_PID( 0x0B40ul, 0x0111ul ), 0, 1, {0} } 							// UZBee
    ,
    { INIT_CL_SC_P( 0x08ul, 0x06ul, 0x50ul ), 0, 2, {TPL_CLASS_DRV} } 			// thumb drive
    ,
    { INIT_VID_PID( 0x0403ul, 0x6001ul ), 0, 3, {0} }, 							// FTDI Chip
};
