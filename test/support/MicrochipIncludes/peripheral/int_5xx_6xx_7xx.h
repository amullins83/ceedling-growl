...
typedef enum
{
    ...
    INT_SPI2A,              // SPI2A Vector
    INT_SPI1A,              // SPI1A Vector
    INT_SPI3A,              // SPI3A Vector
    
    INT_SPI1E,              // SPI1 Fault
    INT_SPI2AE,             // SPI2A Fault
    INT_SPI1AE,             // SPI1A Fault
    INT_SPI3AE,             // SPI3A Fault

    INT_SPI1TX,             // SPI1 Transfer Done
    INT_SPI2ATX,            // SPI2A Transfer Done
    INT_SPI1ATX,            // SPI1A Transfer Done
    INT_SPI3ATX,            // SPI3A Transfer Done

    INT_SPI1RX,             // SPI1 Receive Done
    INT_SPI2ARX,            // SPI2A Receive Done
    INT_SPI1ARX,            // SPI1A Receive Done
    INT_SPI3ARX,            // SPI3A Receive Done

    INT_I2C1,               // I2C1 Vector
    INT_I2C2,               // I2C2 Vector
    INT_I2C1A,              // I2C1A Vector
    INT_I2C2A,              // I2C2A Vector
    INT_I2C3A,              // I2C3A Vector

    INT_I2C1B,              // I2C1 Bus Colision Event
    INT_I2C2B,              // I2C2 Bus Colision Event
    INT_I2C1AB,             // I2C1A Bus Colision Event
    INT_I2C2AB,             // I2C2A Bus Colision Event
    INT_I2C3AB,             // I2C3A Bus Colision Event

    INT_I2C1S,              // I2C1 Slave Event
    INT_I2C2S,              // I2C2 Slave Event
    INT_I2C1AS,             // I2C1A Slave Event
    INT_I2C2AS,             // I2C2A Slave Event
    INT_I2C3AS,             // I2C3A Slave Event

    INT_I2C1M,              // I2C1 Master Event
    INT_I2C2M,              // I2C2 Master Event
    INT_I2C1AM,             // I2C1A Master Event
    INT_I2C2AM,             // I2C2A Master Event
    INT_I2C3AM,             // I2C3A Master Event

    INT_U1A,                // UART1A Vector
    INT_U3A,                // UART3A Vector
    INT_U1B,                // UART1B Vector
    INT_U2A,                // UART2A Vector
    INT_U2B,                // UART2B Vector
    INT_U3B,                // UART3B Vector

    INT_U1AE,               // UART1A Error Event
    INT_U3AE,               // UART3A Error Event
    INT_U1BE,               // UART1B Error Event
    INT_U2AE,               // UART2A Error Event
    INT_U2BE,               // UART2B Error Event
    INT_U3BE,               // UART3B Error Event

    INT_U1ARX,              // UART1A RX Event
    INT_U3ARX,              // UART3A RX Event
    INT_U1BRX,              // UART1B RX Event
    INT_U2ARX,              // UART2A RX Event
    INT_U2BRX,              // UART2B RX Event
    INT_U3BRX,              // UART3B RX Event
    
    INT_U1ATX,              // UART1A TX Event
    INT_U3ATX,              // UART3A TX Event
    INT_U1BTX,              // UART1B TX Event
    INT_U2ATX,              // UART2A TX Event
    INT_U2BTX,              // UART2B TX Event
    INT_U3BTX,              // UART3B TX Event
...
#define INT_SOURCE_UART(chn)            /*DOM-IGNORE-BEGIN*/(INT_U1A + (chn))           /*DOM-IGNORE-END*/
// UART Error Interrupt Channel.
#define INT_SOURCE_UART_ERROR(chn)      /*DOM-IGNORE-BEGIN*/(INT_U1AE + (chn))          /*DOM-IGNORE-END*/
// UART Receive Interrupt Channel.
#define INT_SOURCE_UART_RX(chn)         /*DOM-IGNORE-BEGIN*/(INT_U1ARX + (chn))         /*DOM-IGNORE-END*/
// UART Transmit Interrupt Channel.
#define INT_SOURCE_UART_TX(chn)         /*DOM-IGNORE-BEGIN*/(INT_U1ATX + (chn))         /*DOM-IGNORE-END*/
...
typedef enum
{
    ...
    INT_SPI_2A_VECTOR,                // SPI2A Vector
    INT_SPI_1A_VECTOR,                // SPI1A Vector
    INT_SPI_3A_VECTOR,                // SPI3A Vector

    INT_UART_1A_VECTOR,               // UART1A Vector
    INT_UART_3A_VECTOR,               // UART3A Vector
    INT_UART_2A_VECTOR,               // UART1B Vector
    INT_UART_1B_VECTOR,               // UART2A Vector
    INT_UART_2B_VECTOR,               // UART2B Vector
    INT_UART_3B_VECTOR,               // UART3B Vector

    INT_I2C_1_VECTOR,                 // I2C1 Vector
    INT_I2C_2_VECTOR,                 // I2C2 Vector
    INT_I2C_1A_VECTOR,                // I2C1A Vector
    INT_I2C_2A_VECTOR,                // I2C2A Vector
    INT_I2C_3A_VECTOR,                // I2C3A Vector
...
// UART Interrupt Channel
#define INT_VECTOR_UART(chn)            /*DOM-IGNORE-BEGIN*/(INT_UART_1A_VECTOR + (chn))            /*DOM-IGNORE-END*/
// DMA Interrupt Channel
