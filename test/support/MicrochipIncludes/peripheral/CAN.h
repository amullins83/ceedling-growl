...
/* CAN Filter Mask Type 
  ...
  Description:
    ...
    process any type of message, both SID and EID messages will accepted on a filter
    match. 
*/
...
/* CAN TX Channel Priority 
  ...
  Description:
    ...
    TX channel are assigned the same priority level. Channel 1 has higher natural
...
typedef enum 
{
	...
	CAN_DNET_FILTER_SIZE_2_BIT,     // Device Net Filter is 2 bit long
	CAN_DNET_FILTER_SIZE_3_BIT,     // Device Net Filter is 3 bit long
	CAN_DNET_FILTER_SIZE_4_BIT,     // Device Net Filter is 4 bit long
	CAN_DNET_FILTER_SIZE_5_BIT,     // Device Net Filter is 5 bit long
	CAN_DNET_FILTER_SIZE_6_BIT,     // Device Net Filter is 6 bit long
	CAN_DNET_FILTER_SIZE_7_BIT,     // Device Net Filter is 7 bit long
	CAN_DNET_FILTER_SIZE_8_BIT,     // Device Net Filter is 8 bit long
	CAN_DNET_FILTER_SIZE_9_BIT,     // Device Net Filter is 9 bit long
	CAN_DNET_FILTER_SIZE_10_BIT,     // Device Net Filter is 10 bit long
	CAN_DNET_FILTER_SIZE_11_BIT,     // Device Net Filter is 11 bit long
	CAN_DNET_FILTER_SIZE_12_BIT,     // Device Net Filter is 12 bit long
	CAN_DNET_FILTER_SIZE_13_BIT,     // Device Net Filter is 13 bit long
	CAN_DNET_FILTER_SIZE_14_BIT,     // Device Net Filter is 14 bit long
	CAN_DNET_FILTER_SIZE_15_BIT,     // Device Net Filter is 15 bit long
	CAN_DNET_FILTER_SIZE_16_BIT,     // Device Net Filter is 16 bit long
	CAN_DNET_FILTER_SIZE_17_BIT,     // Device Net Filter is 17 bit long
	CAN_DNET_FILTER_SIZE_18_BIT,     // Device Net Filter is 18 bit long
...
/*******************************************************************************
  ...
  Precondition:
    CAN module should preferably be in Configuration Mode (using the 
    CANSetOperatingMode() function).
...
/*******************************************************************************
  ...
  Summary:
    Returns TRUE if TX abort operation is complete.
...
/*******************************************************************************
  ...
  Returns:
    Returns NULL if there aren't any messages in the channel; otherwise returns a
